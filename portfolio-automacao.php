...
<html>
<head>
  <title>Empresa Junior Engenharia</title>
...
<div id="project-section">
  <div class="container">
    <div class="theme-title">
      <h2 align="center"> <img src="images/marcadorSessao.png"> Nossos melhores projetos de Automação</h2>
      <br>
    ...
    <div class="project-menu">
      <ul>
        <li class="filter tran3s" data-filter=".web">IOT</li>
        <li class="filter tran3s" data-filter=".photo">Automação de ar condicionado</li>
        <li class="filter tran3s" data-filter=".webd">Automação de bombas</li>
      </ul>
    </div>
