...
<div id="project-section">
  <div class="container">
    <div class="theme-title">
      <h2 align="center"><img src="images/marcadorSessao.png">  Nossos melhores projetos de Cívil</h2>
      <br>
    ...
    <div class="project-menu">
      <ul>
        <li class="filter tran3s" data-filter=".web">Combate a incendio</li>
        <li class="filter tran3s" data-filter=".photo">Hidrossanitario</li>
