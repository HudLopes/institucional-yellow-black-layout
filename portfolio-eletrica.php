...
<div id="project-section">
  <div class="container">
    <div class="theme-title">
      <h2 align="center"><img src="images/marcadorSessao.png"> Nossos melhores projetos de Eletrica</h2>
      <br>
    ...
    <div class="project-menu">
      <ul>
        <li class="filter tran3s" data-filter=".web">SPDA</li>
        <li class="filter tran3s" data-filter=".photo">Efeciencia Energética</li>
